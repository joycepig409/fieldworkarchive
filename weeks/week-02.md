...
課堂最後我們去找校園裡沒有按照原本規劃被使用的地方。我們找到二餐三樓的1001空間。
整體空間大概長這樣；
...
相較之下我們這組找到的 1001 空間好像沒有留下那麼明顯的物質改造。兩個人躺在地上，過一陣子起來走掉，地板可能完全沒有改變。如果只帶回照片，照片可以證明有兩個人躺在這裡，卻不能證明後面那個推論。冷氣涼涼、坐墊軟軟、脫鞋後腳底接觸木地板的感覺都沒有進入照片。甚至如果只看第三張圖，也可能只得到有人在地上睡覺或兩個人在打鬧這類完全不同的敘事。好像可以體會到了，痕跡本身並不等於證據，但它要支持什麼說法是被選擇過的，且仍然需要其他線索和解讀。
